<template>
    <div id="hamburger" class="hamburglar" v-bind:class="{'is-open': isActive}" v-on:click="isActive=!isActive"  @click="onClick">
        ...
        <div class="burger-ring">
            <svg class="svg-ring">
                <path class="path" fill="none" stroke="#3d9c90" stroke-miterlimit="10" stroke-width="4" d="M 34 2 C 16.3 2 2 16.3 2 34 s 14.3 32 32 32 s 32 -14.3 32 -32 S 51.7 2 34 2" />
            </svg>
        </div>
...
<style lang="scss" scoped>
    // vars
    $color: #3d9c90;		  // icon color
    $blue: inherit;	  // background color
    $animation: 0.6s;	// animation speed
    $scale: .5;			  // icon scale 68/68 default
